    ...
    <div class="i_car">
        ...
        <div class="car_bg">
            ...
            <ul class="cars">
                ...
                <li>
                	<div class="img"><a href="#"><img src="<%=basePath %>/static/images/car2.jpg" width="58" height="58" /></a></div>
...
<div class="menu_bg">
	<div class="menu">
    	...
    	<div class="nav">
            ...
            <div class="leftNav">
                <ul>      
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav1.png" /></span>
                        ...
                        <div class="zj">
                            ...
                            <div class="zj_r">
                                <a href="#"><img src="<%=basePath %>/static/images/n_img1.jpg" width="236" height="200" /></a>
                                <a href="#"><img src="<%=basePath %>/static/images/n_img2.jpg" width="236" height="200" /></a>
                            </div>
                        </div>
                    </li>
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav2.png" /></span>
                    ...
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav3.png" /></span>
                    ...
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav4.png" /></span>
                    ...
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav5.png" /></span>
                    ...
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav6.png" /></span>
                    ...
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav7.png" /></span>
                    ...
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav8.png" /></span>
                    ...
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav9.png" /></span>
                    ...
                    <li>
                    	<div class="fj">
                        	<span class="n_img"><span></span><img src="<%=basePath %>/static/images/nav10.png" /></span>
        ...
        <!--End 商品分类详情 End-->                                                     
    	<ul class="menu_r">
            <c:forEach items="${hxNavList}" var="map">
                <li><a href="${map.url}">${map.title}</a></li>
            </c:forEach>
        </ul>
...
<div class="i_bg bg_color">
    ...
    <div class="content mar_10">
    	<div class="h_l_img">
        	<div class="img"><img src="<%=basePath %>/static/images/l_img.jpg" width="188" height="188" /></div>
            <div class="pri_bg">
                ...
                <div id="feature">
                    <div id="block">
                        <div id="botton-scroll">
                            <ul class="featureUL">
                                <c:forEach items="${hotProductList}" var="map">
                                    <li class="featureBox">
                                        <div class="box">
    ...
    <div class="content">
    	<div class="i_sell">
            <div id="imgPlay">
                <ul class="imgs" id="actor">
                    <li><a href="#"><img src="<%=basePath %>/static/images/tm_r.jpg" width="211" height="357" /></a></li>
                    <li><a href="#"><img src="<%=basePath %>/static/images/tm_r.jpg" width="211" height="357" /></a></li>
                    <li><a href="#"><img src="<%=basePath %>/static/images/tm_r.jpg" width="211" height="357" /></a></li>
                </ul>
        ...
        <div class="sell_right">
        	<div class="sell_1">
            	<div class="s_img"><a href="#"><img src="<%=basePath %>/static/images/tm_1.jpg" width="185" height="155" /></a></div>
            ...
            <div class="sell_2">
            	<div class="s_img"><a href="#"><img src="<%=basePath %>/static/images/tm_2.jpg" width="185" height="155" /></a></div>
            ...
            <div class="sell_b1">
            	<div class="sb_img"><a href="#"><img src="<%=basePath %>/static/images/tm_b1.jpg" width="242" height="356" /></a></div>
            	<div class="s_price">￥<span>289</span></div>
                <div class="s_name">
                	<h2><a href="#">东北大米</a></h2>
                    倒计时：<span>1200</span> 时 <span>30</span> 分 <span>28</span> 秒
            ...
            <div class="sell_3">
            	<div class="s_img"><a href="#"><img src="<%=basePath %>/static/images/tm_3.jpg" width="185" height="155" /></a></div>
            	<div class="s_price">￥<span>289</span></div>
                <div class="s_name">
                	<h2><a href="#">迪奥香水</a></h2>
                    倒计时：<span>1200</span> 时 <span>30</span> 分 <span>28</span> 秒
            ...
            <div class="sell_4">
            	<div class="s_img"><a href="#"><img src="<%=basePath %>/static/images/tm_4.jpg" width="185" height="155" /></a></div>
            	<div class="s_price">￥<span>289</span></div>
                <div class="s_name">
                	<h2><a href="#">美妆</a></h2>
                    倒计时：<span>1200</span> 时 <span>30</span> 分 <span>28</span> 秒
            ...
            <div class="sell_b2">
            	<div class="sb_img"><a href="#"><img src="<%=basePath %>/static/images/tm_b2.jpg" width="242" height="356" /></a></div>
            	<div class="s_price">￥<span>289</span></div>
                <div class="s_name">
                	<h2><a href="#">美妆</a></h2>
                    倒计时：<span>1200</span> 时 <span>30</span> 分 <span>28</span> 秒
        	...
        	<div class="food_ban">
            	<div id="imgPlay2">
                    <ul class="imgs" id="actor2">
                        <li><a href="#"><img src="<%=basePath %>/static/images/food_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/food_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/food_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_mid">
        	<ul>
            	<li>
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/food_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/food_2.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/food_3.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/food_4.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/food_5.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/food_6.jpg" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="<%=basePath %>/static/images/food_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="<%=basePath %>/static/images/food_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 食品饮料 End-->
        	...
        	<div class="make_ban">
            	<div id="imgPlay3">
                    <ul class="imgs" id="actor3">
                        <li><a href="#"><img src="<%=basePath %>/static/images/make_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/make_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/make_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_mid">
        	<ul>
            	<li>
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/make_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/make_2.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/make_3.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/make_4.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/make_5.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/make_6.jpg" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="<%=basePath %>/static/images/make_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="<%=basePath %>/static/images/make_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 个人美妆 End-->
        	...
        	<div class="baby_ban">
            	<div id="imgPlay4">
                    <ul class="imgs" id="actor4">
                        <li><a href="#"><img src="<%=basePath %>/static/images/baby_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/baby_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/baby_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_mid">
        	<ul>
            	<li>
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/baby_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/baby_2.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/baby_3.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/baby_4.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/baby_5.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/baby_6.jpg" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="<%=basePath %>/static/images/baby_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="<%=basePath %>/static/images/baby_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 母婴玩具 End-->
        	...
        	<div class="home_ban">
            	<div id="imgPlay5">
                    <ul class="imgs" id="actor5">
                        <li><a href="#"><img src="<%=basePath %>/static/images/home_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/home_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/home_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_mid">
        	<ul>
            	<li>
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/home_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/home_2.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/home_3.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/home_4.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/home_5.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/home_6.jpg" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="<%=basePath %>/static/images/home_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="<%=basePath %>/static/images/home_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 家居生活 End-->
        	...
        	<div class="tel_ban">
            	<div id="imgPlay6">
                    <ul class="imgs" id="actor6">
                        <li><a href="#"><img src="<%=basePath %>/static/images/tel_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/tel_r.jpg" width="211" height="286" /></a></li>
                        <li><a href="#"><img src="<%=basePath %>/static/images/tel_r.jpg" width="211" height="286" /></a></li>
                    </ul>
        ...
        <div class="fresh_mid">
        	<ul>
            	<li>
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/tel_1.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/tel_2.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/tel_3.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/tel_4.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/tel_5.jpg" width="185" height="155" /></a></div>
                </li>
                <li>
                	<div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="<%=basePath %>/static/images/tel_6.jpg" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
        <div class="fresh_right">
        	<ul>
            	<li><a href="#"><img src="<%=basePath %>/static/images/tel_b1.jpg" width="260" height="220" /></a></li>
                <li><a href="#"><img src="<%=basePath %>/static/images/tel_b2.jpg" width="260" height="220" /></a></li>
            </ul>
        </div>
    </div>    
    <!--End 数码家电 End-->
    ...
    <div class="b_btm_bg b_btm_c">
        <div class="b_btm">
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="72"><img src="<%=basePath %>/static/images/b1.png" width="62" height="62" /></td>
                <td><h2>正品保障</h2>正品行货  放心购买</td>
              </tr>
            </table>
			<table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="72"><img src="<%=basePath %>/static/images/b2.png" width="62" height="62" /></td>
                <td><h2>满38包邮</h2>满38包邮 免运费</td>
              </tr>
            </table>
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="72"><img src="<%=basePath %>/static/images/b3.png" width="62" height="62" /></td>
                <td><h2>天天低价</h2>天天低价 畅选无忧</td>
              </tr>
            </table>
            <table border="0" style="width:210px; height:62px; float:left; margin-left:75px; margin-top:30px;" cellspacing="0" cellpadding="0">
              <tr>
                <td width="72"><img src="<%=basePath %>/static/images/b4.png" width="62" height="62" /></td>
    ...
    <div class="b_nav">
        ...
        <div class="b_er">
            <div class="b_er_c"><img src="<%=basePath %>/static/images/er.gif" width="118" height="118" /></div>
            <img src="<%=basePath %>/static/images/ss.png" />
        </div>
    </div>    
    <div class="btmbg">
		<div class="btm">
                    ...
                    <li>
                        <div class="img">
                            <a href="javascript:void(0)">
                                <img src="${ctx}/statics/<%=basePath %>/static/images/car1.jpg" width="58" height="58">
                            </a>
                        </div>
                        <div class="name">
