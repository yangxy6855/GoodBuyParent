...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div id="tsShopContainer">
            <#--<div id="tsImgS"><a href="images/p_big.jpg" title="Images" class="MagicZoom" id="MagicZoom">
                <img src="images/p_big.jpg" width="390" height="390" /></a></div>-->
            <div id="tsImgS"><a href="${imgUrlList[0]}" title="Images" class="MagicZoom" id="MagicZoom">
                <img src="${imgUrlList[0]}" width="390" height="390" /></a></div>
                ...
                <div id="tsImgSCon">
                    <ul>
                        <#list imgUrlList as temp>
                            <#if temp_index==0>
                                <li onclick="showPic(${temp_index})" rel="MagicZoom" class="tsSelectImg">
                ...
                <script type="text/javascript">
                    jQuery(function(){
                        ...
                        jQuery("#discuss").click(function(){
                            //获取当前商品的商品编号
                            var productNum = jQuery("input[name=productNum]").val();
                            jQuery.ajax({
                                url:"http://localhost:8087/discuss/getDiscuss/"+productNum,
                                type:"POST",
                                dataType:"JSON",
                                success:function(rs){
                                    console.log(rs);
                                    ...
                                    for(var i in rs){
                                        content+="<tr valign=\"top\">\n" +
                                                "<td width=\"160\"><img src='"+rs[i].iconCls+"' width=\"20\" height=\"20\" align=\"absmiddle\" />&nbsp;"+rs[i].uName+"</td>\n" +
                                                "<td width=\"180\">\n" +
                                                ...
                                                "<td>\n" +
                                                "\t"+rs[i].content+"<br />\n" +
                                                "\t<font color=\"#999999\">"+rs[i].createDate+"</font>\n" +
                                                "</td>\n" +
                                                "</tr>"
                                    }
